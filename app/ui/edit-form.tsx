...
export default function EditBookForm({
  ...
  return (
    <form action={updateBookWithId}>
      <div className="rounded-md bg-[#F8F4E1] py-28 p-8">
        {/* Book Title */}
        <div className="mb-4">
      ...
      <div className="mt-6 flex justify-end gap-4">
        <Link
          href="/home"
          className="flex h-10 items-center rounded-lg bg-gray-100 px-4 text-sm font-medium text-gray-600 transition-colors hover:bg-red-500"
        >
          Cancel
        </Link>
